@"
    Generates a CA certificate and a localhost certificate for use with the application.
    Outputs a CA folder and a localhost folder with the certificates and keys with can be added to the system and the
    browser's trusted certificate store.
    Copyright (C) 2023 Wriar

"@

Write-Host "Sample Certificate Generation Utility"
Write-Host "----------------------------------------------"
Write-Host "This utility will generate a CA certificate and a localhost certificate for use with this application."
